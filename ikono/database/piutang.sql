...
--
-- Host: 0.tcp.ap.ngrok.io    Database: pradita
-- ------------------------------------------------------
...
CREATE TABLE `piutang` (
  ...
  `status_lunas` tinyint DEFAULT '0',
  PRIMARY KEY (`id_piutang`),
  KEY `id_pelanggan_idx` (`id_pelanggan`),
  CONSTRAINT `fk_id_pelanggan` FOREIGN KEY (`id_pelanggan`) REFERENCES `pembeli` (`id_pembeli`)
...
-- Dump completed on 2024-12-14 15:35:35
