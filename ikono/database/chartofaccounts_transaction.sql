...
CREATE TABLE `transaction` (
  ...
  KEY `code_idx` (`AccountNumber`),
  CONSTRAINT `code` FOREIGN KEY (`AccountNumber`) REFERENCES `chartofaccounts` (`AccountNumber`)
...
INSERT INTO `transaction` VALUES (1,1100,0,0,'Deposit');
