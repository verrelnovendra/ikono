...
public class DatabaseConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/gudang"; // Ganti "localhost" dan "3306" sesuai server Anda
    private static final String USER = "root";                             // Ganti sesuai username database
    private static final String PASSWORD = "zikry1106";                             // Ganti sesuai password database
